...
public class SecondboardApplication {
  ...
  public String uploadPath() {
    return "C:\\Users\\asus\\project\\tennis-project\\secondboard\\src\\main\\resources\\static\\files";
  }
  @Bean
...
//            fileItem = new File(
//              "C:\\Users\\asus\\project\\tennis-project\\secondboard\\src\\main\\resources\\static\\files/profile_ma.png");
//          } else {
//            fileItem = new File(
//              "C:\\Users\\asus\\project\\tennis-project\\secondboard\\src\\main\\resources\\static\\files/profile_fe.png");
//          }
...
//        try {
//          fileItem = new File(
//            "C:\\Users\\asus\\project\\tennis-project\\secondboard\\src\\main\\resources\\static\\files/profile_ma.jpeg");
//          FileInputStream input = new FileInputStream(fileItem);
//          MultipartFile multipartFile = new MockMultipartFile("fileItem",
//            fileItem.getName(), "image/png", IOUtils.toByteArray(input));
//          MemberUploadFile uploadFile = memberImageService.newStore(multipartFile);
